...
insert into OBDII_PIDs (service_id, PID, PID_description, once) values
    ...
    (1, 2, 'Обнаруженные диагностические коды ошибок', false), (1, 3, 'Состояние топливной системы', false),
    (1, 4, 'Расчетное значение нагрузки на двигатель', false), (1, 5, 'Температура охлаждающей жидкости', false),
    (1, 6, 'Кратковременная топливная коррекция—Bank 1', false), (1, 7, 'Долговременная топливная коррекция—Bank 1', false),
    (1, 8, 'Кратковременная топливная коррекция—Bank 2', false), (1, 9, 'Долговременная топливная коррекция—Bank 2', false),
    (1, 10, 'Давление топлива', false), (1, 11, 'Давление во впускном коллекторе (абсолютное)', false),
    (1, 12, 'Обороты двигателя', false), (1, 13, 'Скорость автомобиля', false),
    (1, 14, 'Угол опережения зажигания', false), (1, 15, 'Температура всасываемого воздуха', false),
    (1, 16, 'Массовый расход воздуха', false), (1, 17, 'Положение дроссельной заслонки', false),
    (1, 18, 'Запрограммированный режим подачи вторичного воздуха', false), (1, 19, 'Наличие датчиков кислорода (1)', false),
    (1, 20, 'Bank 1, Sensor 1: напряжение датчика кислорода, кратковременный запас топлива', false),
    (1, 21, 'Bank 1, Sensor 2: напряжение датчика кислорода, кратковременный запас топлива', false),
    (1, 22, 'Bank 1, Sensor 3: напряжение датчика кислорода, кратковременный запас топлива', false),
    (1, 23, 'Bank 1, Sensor 4: напряжение датчика кислорода, кратковременный запас топлива', false),
    (1, 24, 'Bank 2, Sensor 1: напряжение датчика кислорода, кратковременный запас топлива', false),
    (1, 25, 'Bank 2, Sensor 2: напряжение датчика кислорода, кратковременный запас топлива', false),
    (1, 26, 'Bank 2, Sensor 3: напряжение датчика кислорода, кратковременный запас топлива', false),
    (1, 27, 'Bank 2, Sensor 4: напряжение датчика кислорода, кратковременный запас топлива', false),
    (1, 28, 'Соответствие этого автомобиля стандартам OBD', true), (1, 29, 'Наличие датчиков кислорода (2)', true),
    (1, 30, 'Состояние вспомогательного входного сигнала', false), (1, 31, 'Время, прошедшее с запуска двигателя', false);
